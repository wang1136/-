...
public class ChessGameFrame extends JFrame {
    ...
    private void addResetButton() {
        ...
        button.setLocation(HEIGHT-40, HEIGHT / 10 + 120);
    ...
    private void addLoadButton() {
        ...
        button.setLocation(HEIGHT-40, HEIGHT / 10 + 240);
        button.setSize(200, 60);
        button.setFont(new Font("Rockwell", Font.BOLD, 20));
        add(button);
    ...
    private void addSaveButton() {
        ...
        button.addActionListener(e -> {
            ...
            String path = JOptionPane.showInputDialog(this,"Input Path here");
            gameController.writeStringToTxt(path, gameController.getChessboard().stringChessboard());
        });
        button.setLocation(HEIGHT-40, HEIGHT / 10 + 360);
        button.setSize(200, 60);
        button.setFont(new Font("Rockwell", Font.BOLD, 20));
        add(button);
    }
